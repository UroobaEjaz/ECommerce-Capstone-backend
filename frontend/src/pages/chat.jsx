        ...
        steps={[
          ...
          },
          {
            ...
            options: [
              ...
              {
                value: "complaint",
                label: "Are you having a complaint?",
                trigger: "5",
              },
            ],
          },
          {
            id: "4",
            message:
              "You selected Return. Please call us at `123-456-7890`, our agent will be at your service. Thank you.",
            end: true,
          },
          {
            id: "5",
            message:
              "You selected Complaint. Please provide details of your complaint by calling us at `123-456-7890`",
            end: true,
          },
        ]}
        floating={true}
