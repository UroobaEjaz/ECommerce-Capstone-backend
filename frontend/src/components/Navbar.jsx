...
const Navbar = ({ size }) => {
  ...
  return (
    <div>
      <nav className="bg-white shadow-md px-10 flex justify-between top-0 left-0 z-10 fixed items-center w-full font-bold">
      ...
      <div className="h-[0.5px] w-full mt-20 bg-red-600"></div>
    </div>
  );
};
